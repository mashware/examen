...
/**
 * @ORM\Entity(
 *     repositoryClass="App\Infrastructure\Repository\DropShippingPedidosDoctrineRepository"
 * )
 */
class DropShippingPedidos
{
    ...
    public function setFechaEntregaPrevistaMin(?\DateTimeInterface $fecha_entrega_prevista_min): self
    {
    ...
    public function setFechaEntregaPrevista(?\DateTimeInterface $fecha_entrega_prevista): self
    {
    ...
    public function setEmailPedidoEnviado(?int $email_pedido_enviado): self
    {
