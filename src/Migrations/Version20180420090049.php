 ...
 */
class Version20180420090049 extends AbstractMigration
{
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE drop_shiping');
    }
}
